...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "TUSHARE_PRIORITY": {
        "title": "Tushare Priority",
        "description": "Priority for Tushare data source. Lower number means higher priority.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "AKSHARE_PRIORITY": {
        "title": "AkShare Priority",
        "description": "Priority for AkShare data source. Lower number means higher priority.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "EFINANCE_PRIORITY": {
        "title": "EFinance Priority",
        "description": "Priority for EFinance data source. Lower number means higher priority.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "PYTDX_PRIORITY": {
        "title": "Pytdx Priority",
        "description": "Priority for Pytdx data source. Lower number means higher priority.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "BAOSTOCK_PRIORITY": {
        "title": "Baostock Priority",
        "description": "Priority for Baostock data source. Lower number means higher priority.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "YFINANCE_PRIORITY": {
        "title": "YFinance Priority",
        "description": "Priority for YFinance data source. Lower number means higher priority.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "VISION_MODEL": {
        "title": "Vision Model",
        "description": "Vision model used for image understanding. Preferred over OPENAI_VISION_MODEL.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "VISION_PROVIDER_PRIORITY": {
        ...
        "description": "Comma-separated provider priority for image understanding calls.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "gemini,anthropic,openai",
        "options": [],
        "validation": {},
        "display_order": 59,
    },
    "USE_PROXY": {
        "title": "Use Proxy",
        "description": "Whether to route supported data requests through a local proxy.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "PROXY_HOST": {
        "title": "Proxy Host",
        "description": "Proxy host used when USE_PROXY is enabled.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "PROXY_PORT": {
        "title": "Proxy Port",
        "description": "Proxy port used when USE_PROXY is enabled.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "ENABLE_EASTMONEY_PATCH": {
        "title": "EastMoney Patch",
        "description": "Enable EastMoney compatibility patch for environments with unstable response formats.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "DATABASE_PATH": {
        "title": "Database Path",
        "description": "Path to the SQLite database used for reports, history, and auth state.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "./data/stock_analysis.db",
        "options": [],
        "validation": {},
        "display_order": 22,
    },
    "LOG_DIR": {
        "title": "Log Directory",
        "description": "Directory used to store application logs.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "WEBUI_ENABLED": {
        ...
        "description": "Whether to enable the built-in Web UI service by default.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "WEBUI_HOST": {
        "title": "Web UI Host",
        "description": "Host address bound by the Web UI service.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "WEBUI_AUTO_BUILD": {
        ...
        "description": "Whether to automatically build the frontend before launching the Web UI service.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "TRUST_X_FORWARDED_FOR": {
        ...
        "description": "Trust reverse-proxy forwarded headers to determine the real client IP.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "ADMIN_SESSION_MAX_AGE_HOURS": {
        "title": "Admin Session Max Age",
        "description": "Maximum session age for admin login, in hours.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
